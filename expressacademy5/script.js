...
$(document).ready(function() {
  ...
  // callUserViewedAPI("expressacademy5"); // automatically converted during replace, to the stream name
});
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=expressacademy5";
