...
const API_URL = "https://api.deafassistant.com/stream/LiteGetStream?streamName=lambda";
const LAYOVER_HTML = `
  <div class="inner-div">
...
$(document).ready(function () {
  ...
  // callUserViewedAPI("lambda"); // Automatically converted during replace, to the stream name
});
...
const mockObject2 = {
  "id":59,"timestamp":"2025-01-29T04:36:36.4389888","roomName":"lambda","description":"","isActivelyStreaming":true,
