$(document).ready(function() {
  ...
  // callUserViewedAPI("5starav"); // automatically converted during replace, to the stream name
  checkLanguage();	
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=5starav";
