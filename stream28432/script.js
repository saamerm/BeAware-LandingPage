$(document).ready(function() {
  ...
  // callUserViewedAPI("stream28432"); // automatically converted during replace, to the stream name
  checkLanguage();	
});
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=stream28432";
