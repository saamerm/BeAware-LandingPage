$(document).ready(function() {
  ...
  // callUserViewedAPI("stream19062"); // automatically converted during replace, to the stream name
  checkLanguage();	
});
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=stream19062";
