...
$(document).ready(function() {
  ...
  callUserViewedAPI("testreacts11"); // automatically converted during replace, to the stream name
});
...
function getTranscript() {
  var url="https://script.google.com/macros/s/AKfycbzqOWlC9bT6TtLp1QJLzAkwDZJKTcCZYnoDhN4JIMXTo5lEvtPruYb-3vrILj__yO_A/exec?streamName=testreacts11";
