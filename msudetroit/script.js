...
$(document).ready(function() {
  ...
  // callUserViewedAPI("msudetroit"); // automatically converted during replace, to the stream name
});
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=msudetroit";
