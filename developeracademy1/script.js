...
$(document).ready(function() {
  ...
  // callUserViewedAPI("developeracademy1"); // automatically converted during replace, to the stream name
});
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=developeracademy1";
