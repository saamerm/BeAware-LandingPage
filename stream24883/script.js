...
$(document).ready(function() {
  ...
  // callUserViewedAPI("stream24883"); // automatically converted during replace, to the stream name
});
...
function getTranscript() {
  $.support.cors = true;           
  var url="https://api.deafassistant.com/stream/LiteGetStream?streamName=stream24883";
